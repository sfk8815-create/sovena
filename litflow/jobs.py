...
MEM_GUARD_MB = int(os.environ.get("LITFLOW_MEM_GUARD_MB", "12288"))  # 12GB
MAX_LOG = 200
...
class JobManager:
    ...
    def __init__(self, mem_guard_mb: int = MEM_GUARD_MB):
        ...
        self._worker = threading.Thread(target=self._run, daemon=True, name="litflow-worker")
        self._worker.start()
